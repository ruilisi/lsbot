...
`lsbot` 是 **Lingti Secure Bot** 的缩写。名字也呼应了 `ls`——Unix 最基础的命令，第一次拿到新机器时你敲的第一个命令。像 `ls` 一样，lsbot 是一个基础工具：精简、专注、永远可用。
...
**lsbot** — Lingti Secure Bot · [bot.lingti.com](https://bot.lingti.com) · [GitHub](https://github.com/ruilisi/lsbot)
